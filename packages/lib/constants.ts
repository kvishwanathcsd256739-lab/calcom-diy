...
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Pixara Scheduling";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "help@cal.com";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Pixara";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "Pixara";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "Pixara Scheduling";
